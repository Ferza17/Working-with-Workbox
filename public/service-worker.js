...
// Dynamic Caching
workboxSW.router.registerRoute(/.*(?:googleapis|gstatic)\.com*$/, workboxSW.stategies.staleWhileRevalidate({
...
// Dynamic caching
workboxSW.router.registerRoute('https://cdnjs.cloudflare.com/ajax/libs/material-design-lite/1.3.0/material.indigo-pink.min.css', workboxSW.stategies.staleWhileRevalidate({
    cacheName: 'material-css'
}));

// Dynamic Caching if url contain some url
workboxSW.router.registerRoute(/.*(?:firebasestorage\.googleapi)\.com*$/, workboxSW.stategies.staleWhileRevalidate({
...
// Providing an Offline HTML Feedback
...
workboxSW.precache([
  ...
  },
  {
    ...
    "revision": "b79acaba2d15f04855731fe8fa378d59"
  },
  {
    "url": "src/css/app.css",
  ...
  {
    "url": "sw-base.js",
    "revision": "6130110735a9ddcc1cc585ce618709a5"
  },
  {
    "url": "sw.js",
